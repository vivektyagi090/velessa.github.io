  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-ivory text-charcoal h-full shadow-2xl z-10 flex flex-col justify-between border-l border-champagne/30 animate-fade-in">
        {/* Drawer Header */}
        <div className="px-6 py-4 border-b border-beige flex items-center justify-between bg-white/50">
          <div className="flex items-center gap-2">
            <ShoppingBag className="w-5 h-5 text-champagne" />
            <h3 className="font-serif text-lg tracking-wide font-normal text-charcoal">
          ...
          <div className="flex items-center gap-3">
            {items.length > 0 && (
              <button
                type="button"
                onClick={clearCart}
                className="text-[11px] uppercase tracking-wider font-sans text-charcoal-muted hover:text-rose-600 transition-colors cursor-pointer"
              >
                Clear Bag
              </button>
            )}
            <button
              type="button"
              onClick={closeCart}
              className="p-1 text-charcoal-muted hover:text-champagne transition-colors cursor-pointer"
            ...
            <div className="space-y-2 text-xs font-sans">
              ...
              {summary.discount > 0 && (
                <div className="flex justify-between text-champagne-dark font-medium">
                  <span>Discount Coupon ({summary.appliedPromo?.code})</span>
