    ...
    <section className="relative min-h-[75vh] lg:min-h-[82vh] flex flex-col items-center justify-start overflow-hidden bg-charcoal">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-ivory pt-3 sm:pt-4 lg:pt-6 pb-10 sm:pb-14 animate-fade-in">
        ...
        <div className="grid grid-cols-3 gap-6 max-w-xl mx-auto mt-16 pt-10 border-t border-ivory/20 text-center font-sans">
          <div>
            <span className="block font-serif text-xl sm:text-2xl text-champagne">24K Pure</span>
            <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-ivory/70">Gold Forming Layer</span>
          </div>
          <div>
            <span className="block font-serif text-xl sm:text-2xl text-champagne">100%</span>
            <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-ivory/70">Anti-Tarnish Polish</span>
          </div>
          <div>
            <span className="block font-serif text-xl sm:text-2xl text-champagne">Handcrafted</span>
            <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-ivory/70">Master Quality</span>
          </div>
        </div>
      </div>
