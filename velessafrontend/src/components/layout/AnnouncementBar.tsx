...
export const AnnouncementBar: React.FC = () => {
  ...
  return (
    <aside aria-label="Announcement" className="bg-charcoal text-ivory text-[11px] sm:text-xs py-2 px-4 border-b border-champagne/20 relative z-40 transition-all font-sans print:hidden">
