...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-charcoal text-ivory pt-16 pb-32 lg:pb-12 border-t border-champagne/30 print:hidden">
      {/* Brand Trust Badges */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <ul className="space-y-2.5 text-sm font-sans text-ivory/70">
              ...
              <li>
                <button
                  ...
                  className="hover:text-champagne transition-colors text-left cursor-pointer"
                >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-ivory/70 font-sans leading-relaxed">
              Receive private invitations to preview fine jewellery debuts and exclusive collections.
            </p>
            {subscribed ? (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 border-t border-ivory/10 flex flex-col sm:flex-row items-center justify-between text-xs text-ivory/50 font-sans gap-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link to="/shopkeeper" className="text-ivory/20 hover:text-champagne transition-colors text-[10px] tracking-wider uppercase">
            Staff Portal
          </Link>
        </div>
      </div>
