...
export const MobileBottomNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 inset-x-0 z-40 lg:hidden bg-ivory/95 backdrop-blur-xl border-t border-champagne/30 rounded-t-2xl shadow-[0_-8px_30px_rgba(0,0,0,0.08)] pb-[max(0.5rem,env(safe-area-inset-bottom))] overflow-visible print:hidden"
    >
