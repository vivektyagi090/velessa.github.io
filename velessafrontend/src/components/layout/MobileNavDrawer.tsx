...
import { X, ChevronRight, Heart, ShoppingBag, User, Phone, Sparkles, LogOut, Package, Store } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
              ...
              {isAuthenticated && (
                <button
                  ...
                  className="flex items-center gap-1 text-rose-600 hover:text-rose-700 font-medium text-[11px]"
                  title="Sign Out"
                >
          ...
          <div className="px-6 py-6 space-y-4">
            ...
            {isAuthenticated && (
              <button
                ...
                className="w-full text-left font-serif text-xl text-champagne hover:text-charcoal transition-colors tracking-wide flex items-center justify-between"
              >
            ...
            {user && (user.role?.toLowerCase() === 'shopkeeper' || user.role?.toLowerCase() === 'admin') && (
              <button
                ...
                className="w-full text-left font-sans text-sm font-semibold uppercase tracking-wider py-2.5 px-3 bg-amber-50 text-amber-900 border border-amber-300/80 rounded-sm hover:bg-amber-100 transition-colors flex items-center justify-between"
              >
                <span className="flex items-center gap-2">
                  <Store className="w-4 h-4 text-champagne-dark" />
                  <span>Shopkeeper & Inventory Desk</span>
                </span>
