...
const FAQS = [
  {
    ...
    a: 'We offer a complimentary digital sizing guide and can dispatch a physical luxury ring sizer to your residence worldwide. You may also schedule a private consultation at our Milan or New York boutiques.'
  },
  {
...
export const ContactPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false);
    setIsSubmitted(true);
    showToast('Your message has been received by our concierge.', 'success', 'Inquiry Dispatched');
  };
  ...
  return (
    <div className="min-h-screen bg-ivory pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        ...
        {/* Two-column layout: Form & Boutique Details */}
            ...
            <div className="bg-white border border-beige p-6 sm:p-8 rounded-sm shadow-sm space-y-6 font-sans text-xs">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-charcoal-muted leading-relaxed mt-0.5">
                      ...
                      Fifth Avenue Boutique, 740 5th Ave, New York, NY 10019
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="block text-sm text-charcoal font-serif">Opening Hours</strong>
                    <p className="text-charcoal-muted leading-relaxed mt-0.5">
