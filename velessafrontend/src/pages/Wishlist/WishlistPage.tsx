      ...
      <div className="relative bg-beige/30 border-b border-beige py-12 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <p className="text-xs sm:text-sm text-charcoal-muted font-sans mt-2">
            Your personal collection of treasured pieces reserved for future consideration.
          </p>
        </div>
      </div>
        ...
        {wishlistProducts.length === 0 ? (
          ...
          <div className="bg-white border border-beige rounded-sm p-12 sm:p-20 text-center max-w-2xl mx-auto mt-8 shadow-sm">
            ...
            <p className="text-xs sm:text-sm text-charcoal-muted font-sans max-w-md mx-auto leading-relaxed mb-8">
              Explore our fine jewellery collections and click the heart icon on any necklace, bangle, or ring to preserve your desires here.
            </p>
            <Link to="/shop">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-beige mb-6">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="text-xs uppercase tracking-wider font-sans text-charcoal-muted hover:text-rose-600 transition-colors"
                >
                  Clear All
                </button>
                <span className="text-beige text-xs">|</span>
                <Link
                  to="/shop"
